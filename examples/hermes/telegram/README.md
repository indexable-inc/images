<p align="center">
  <picture>
    ...
    <img src="assets/hero.svg" width="720" alt="the hermes VM long-polls the Telegram API; you message the bot from the app, no inbound port anywhere">
  </picture>
</p>
...
```sh
# From this directory (examples/hermes/telegram in the index repo).
ix apply .#hermes
```
...
- Everything in the [hermes-agent README](../agent/README.md) about secrets handling, provider swaps, and the trust model applies unchanged here.
