{
  ...
  validateHeights = name: rendered: let
    ...
    checks = [
      ...
      }
      {
        ...
        in "services.minecraft.datapacks.<n>.dimensionTypes.${name}: min_y + height (${toString sum}) must not exceed ${toString (minYHardCeil + 1)}.";
      }
      {
