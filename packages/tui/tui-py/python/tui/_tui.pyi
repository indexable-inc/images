...
Hand-maintained to mirror packages/tui/tui-py/src/. Keep in sync when adding or
...
class TuiInstance:
    ...
    def raw_output(self, tail: int | None = ...) -> bytes: ...
...
class Publisher:
    """Handle to a running producer. Stop with `await stop()`."""
