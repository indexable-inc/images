<p align="center">
  <picture>
    ...
    <img src="assets/hero.svg" width="720" alt="A layer plan is described into a tiny content-addressed image.json, then materialized into a verified OCI tar, with per-layer sharded derivations">
  </picture>
</p>
