<p align="center">
  <picture>
    ...
    <img src="assets/hero.svg" width="720" alt="panes-host decodes guest frames into one Metal-backed NSWindow per toplevel, acks each present back to the guest, and forwards NSEvents as evdev input">
  </picture>
</p>
