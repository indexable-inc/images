{
  ...
  #   systemTools.Agent = false;  subagent spawning; delegation routes through the index kernel instead (#2404)
  #   systemTools.Artifact = false;  claude.ai artifact publishing; enabling surfaces Anthropic design-style skills
  #   systemTools.AskUserQuestion = false;  interactive multiple-choice question dialogs
  #   systemTools.DesignSync = false;  hosted design-sync service
  #   systemTools.EnterPlanMode = false;  plan-mode entry
  #   systemTools.EnterWorktree = false;  session worktree switching (entry)
  #   systemTools.ExitPlanMode = false;  plan-mode exit
  ...
  #   systemTools.TaskCreate = false;  shared task list (agent teams)
  #   systemTools.TaskGet = false;  shared task list (agent teams)
  #   systemTools.TaskList = false;  shared task list (agent teams)
  #   systemTools.TaskOutput = false;  shared task list (agent teams)
  #   systemTools.TaskStop = false;  shared task list (agent teams)
  #   systemTools.TaskUpdate = false;  shared task list (agent teams)
