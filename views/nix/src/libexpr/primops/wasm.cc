...
static Engine & getEngine()
{
    static Engine engine = []() {
        ...
        /* Force bit-identical execution across build hosts. The Wasm spec
           ...
           results flow into eval caches and derivations shared across build
           hosts, where one divergent bit yields divergent store paths. Upstream
