    ...
    bool forceDirty)
{
    ...
    auto treeId = [&] {
        ...
        for (auto & key :
             {"rev", "narHash", "lastModified", "lastModifiedDate", "revCount", "dirtyRev", "dirtyShortRev"})
    ...
    if (!forceDirty) {
        ...
        if (auto rev = input.getRev()) {
            ...
            recordedString("rev", emptyHash.gitRev());
            recordedString("shortRev", emptyHash.gitShortRev());
        }
    ...
    if (auto dirtyRev = fetchers::maybeGetStrAttr(input.attrs, "dirtyRev")) {
        recordedString("dirtyRev", *dirtyRev);
        recordedString("dirtyShortRev", *fetchers::maybeGetStrAttr(input.attrs, "dirtyShortRev"));
    }
