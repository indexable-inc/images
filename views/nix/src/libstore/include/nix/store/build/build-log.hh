...
private:
    ...
    /**
     * @param lineComplete Whether a newline actually terminated this line.
     * A line cut short by the builder exiting is not a complete message, so it
     * is never offered to the JSON parser.
     */
    void flushLine(bool lineComplete);
