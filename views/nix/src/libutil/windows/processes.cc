...
{
    /* Mirrors unix/processes.cc's Pid::kill(): a default-constructed or
       already-waited-on `Pid` is a state a caller can be holding, not
       an invariant this class can enforce, so this is a caller-visible
