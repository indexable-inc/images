...
std::unique_ptr<Logger> makeJSONLogger(Descriptor fd, bool includeNixPrefix = true, bool timestamps = false);

std::unique_ptr<Logger>
makeJSONLogger(const std::filesystem::path & path, bool includeNixPrefix = true, bool timestamps = false);
