...
> **Note**
> This fork does not run hosted CI. What validates a change here, and what
> that does and does not cover, is described in
> [`maintainers/ix/testing.md`](https://github.com/indexable-inc/nix/blob/ix-patched/maintainers/ix/testing.md).
