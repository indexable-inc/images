<p align="center">
  <picture>
    ...
    <img src="assets/hero.svg" width="720" alt="GitHub Actions jobs dispatch to a static runner pool on one NixOS host that shares a warm Nix store and the cache.ix.dev substituter">
  </picture>
</p>
